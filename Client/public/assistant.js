(function () {
    ...
    link.href = "https://aivoice-assistant-1.onrender.com/assistant.css"
       ...
       <div class="shifra-top">
        ...
        <div class="shifra-bottom">
            ...
            <button class="shifra-mic">
               ...
               <img 
               src="https://aivoice-assistant-1.onrender.com/mic.svg"
               alt="mic"
    ...
    button.innerHTML = `
    <img 
    src="https://aivoice-assistant-1.onrender.com/logo.png"
    alt="logo"
    />`;
    ...
    const loadAssistant = async () => {
        try {
            const res = await fetch(`https://aivoice-assistant.onrender.com/api/assistant/config/${userId}`)
      ...
      recognition.onresult = (e)=>{
        ...
        setTimeout( async () => {
            try {
                ...
                const res = await fetch("https://aivoice-assistant.onrender.com/api/assistant/ask" , {
                    method:"POST",
                    headers:{
                        "Content-Type":
                      "application/json",
